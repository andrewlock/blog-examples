...
{
    public class HttpCustomHeaderMiddlewareFunctionalTests : IClassFixture<HttpCustomHeaderFixture<DemoWebsite.Startup>>
    {
        public HttpCustomHeaderMiddlewareFunctionalTests(HttpCustomHeaderFixture<DemoWebsite.Startup> fixture)
        {
